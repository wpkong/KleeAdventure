...
// Called every frame
void AKleeBullet::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AKleeBullet::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp,
	FVector NormalImpulse, const FHitResult& Hit)
{
	GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, TEXT("HITTTT"));
